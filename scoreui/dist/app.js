...
const home = {
  view: function (vnode) {
    return [m("main.col-md-9.ms-sm-auto.col-lg-10.px-md-4", [m(".d-flex.justify-content-between.flex-wrap.flex-md-nowrap.align-items-center.pt-3.pb-2.mb-3.border-bottom", [m("h1.h2", "Dashboard")])])];
  }
};
module.exports = {
  home
...
const {
  navbar
} = __webpack_require__(/*! ./navbar */ "./src/components/navbar.js");
const layout = {
  view: function (vnode) {
    return [m(navbar), m(".container-fluid", [m("div", {
      "class": "row"
    }, [m("div", {
      "class": "col-md-3"
    }, vnode.children[0]), m("div", {
      "class": ""
    }, vnode.children[1])])])];
  }
};
...
const credential = {
  ...
  login(e) {
    ...
    m.request({
      ...
      if (error.code == 400) credential.error = "Erreur de login";
    });
  }
};
const login = {
  view: function (vnode) {
    return [m("main.text-center.form-signin", [m("form", [m("img.mb-4[alt=''][height='57'][src='/docs/5.0/assets/brand/bootstrap-logo.svg'][width='72']"), m("h1.h3.mb-3.fw-normal", "Please sign in"), m(".form-floating", [m("input.form-control[id='floatingInput'][placeholder='name@example.com'][type='email']"), m("label[for='floatingInput']", "Email address")]), m(".form-floating", [m("input.form-control[id='floatingPassword'][placeholder='Password'][type='password']"), m("label[for='floatingPassword']", "Password")]), m(".checkbox.mb-3", [m("label", [m("input[type='checkbox'][value='remember-me']"), " Remember me\n      "])]), m("button.w-100.btn.btn-lg.btn-primary[type='submit']", "Sign in"), m("p.mt-5.mb-3.text-muted", "© 2017–2021")]), "\n"]), "\n"];
  }
};
module.exports = {
  login
...
const navbar = {
  view: function (vnode) {
    return [m("header.header-color.navbar.navbar-dark.sticky-top.flex-md-nowrap.p-0.shadow", [m("a.app-name.navbar-brand.col-md-3.col-lg-2.me-0.px-3[href='#']", "NEIJO"), m("button.navbar-toggler.position-absolute.d-md-none.collapsed[aria-controls='sidebarMenu'][aria-expanded='false'][aria-label='Toggle navigation'][data-bs-target='#sidebarMenu'][data-bs-toggle='collapse'][type='button']", [m("span.navbar-toggler-icon")]), m(".navbar-nav", [m(".nav-item.text-nowrap", [m("a.nav-link.px-3[href='#']", "Se connecter")])])])];
  }
};
module.exports = {
  navbar
...
const sidebar = {
  view: function (vnode) {
    return [m("nav.col-lg-2.d-md-block.bg-light.sidebar.collapse[id='sidebarMenu']", [m(".position-sticky.pt-3", [m("ul.nav.flex-column", [m("li.nav-item", [m("a.nav-link.active[aria-current='page'][href='#']", [m("span[data-feather='home']"), "\n              Dashboard\n            "])]), m("li.nav-item", [m("a.nav-link[href='#']", [m("span[data-feather='file']"), "\n              Tournois\n            "])]), m("li.nav-item", [m("a.nav-link[href='#']", [m("span[data-feather='shopping-cart']"), "\n              Equipes\n            "])]), m("li.nav-item", [m("a.nav-link[href='#']", [m("span[data-feather='users']"), "\n              Joueurs\n            "])]), m("li.nav-item", [m("a.nav-link[href='#']", [m("span[data-feather='bar-chart-2']"), "\n              Matchs\n            "])]), m("li.nav-item", [m("a.nav-link[href='#']", [m("span[data-feather='layers']"), "\n              Groupes\n            "])])])])])];
  }
};
module.exports = {
  sidebar
...
const {
  mountRoutes
} = __webpack_require__(/*! ./mounter */ "./src/mounter.js");
const {
  login
} = __webpack_require__(/*! ./components/login */ "./src/components/login.js");
if (window.localStorage['jwt'] == undefined) mountRoutes();else m.route(document.body, "/login", {
  "/login": {
    render: function () {
      return m(login);
    }
...
const {
  sidebar
} = __webpack_require__(/*! ./components/sidebar */ "./src/components/sidebar.js");
const {
  home
} = __webpack_require__(/*! ./components/home */ "./src/components/home.js");
const {
  layout
} = __webpack_require__(/*! ./components/layout */ "./src/components/layout.js");
