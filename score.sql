...
COPY public.match (id, venue, code, "team1Id", "team2Id", winner, "phaseId", date) FROM stdin;
\.
...
COPY public.team_match_info (id, score, duration, type, "matchId", "teamId", date) FROM stdin;
\.
